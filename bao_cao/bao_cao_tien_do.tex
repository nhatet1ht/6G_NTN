...
\title{\textbf{BÁO CÁO TIẾN ĐỘ NGHIÊN CỨU}\\[4pt]
...
\date{Ngày báo cáo: 14/09/2026 \quad (giai đoạn: 06/09/2026 -- 10/09/2026)}
...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item Hai phương pháp so sánh (HSNF, LBSH) đang dùng bản triển khai rút gọn của mình, chưa
        ...
        gian.
  \item Do giới hạn bộ nhớ GPU hiện có, một số siêu tham số huấn luyện (kích thước lô dữ liệu)
        chưa đúng hoàn toàn như bài báo công bố.
...
\begin{enumerate}[leftmargin=1.2em]
  ...
  \item Nếu còn thời gian: huấn luyện riêng cho từng chòm vệ tinh (hiện đang dùng chuyển giao
        chính sách từ chòm vệ tinh chính sang các chòm khác), và tăng số lần huấn luyện độc
        lập lên 5.
\end{enumerate}
